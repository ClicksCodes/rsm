...
colours = {"delete": 0xF27878, "create": 0x68D49E, "edit": 0xF2D478, "update": 0xF2D478}
...
events = {
    ...
    "reaction_clear": [
        colours["edit"],
        "`Cleared reactions`",
        emojis["reaction_clear"],
        "Messages",
    ],
    "everyone_here": [
        colours["edit"],
        "`@Everyone & @Here`",
        emojis["everyone_ping"],
        "Messages",
    ],
    "mass_mention": [
        colours["edit"],
    ...
    "channel_create": [
        colours["create"],
        "`Created channel  `",
        emojis["channel_create"],
        "Channels",
    ],
    "channel_delete": [
        colours["delete"],
        "`Deleted channel  `",
        emojis["channel_delete"],
        "Channels",
    ],
    "nsfw_update": [
        colours["edit"],
    ...
    "invite_create": [
        colours["create"],
        "`Created invite   `",
        emojis["invite_create"],
        "Server",
    ],
    "invite_delete": [
        colours["delete"],
        "`Deleted invite   `",
        emojis["invite_delete"],
        "Server",
    ],
    "icon_update": [
        colours["edit"],
...
loadingEmbed = discord.Embed(title=f"{emojis['loading']} Loading")
